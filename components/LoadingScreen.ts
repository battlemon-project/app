 ...
 * @see https://doc.babylonjs.com/how_to/creating_a_custom_loading_screen
 */
export default class DefaultLoadingScreen implements ILoadingScreen {
  ...
  public displayLoadingUI(): void {
    ...
    imageSpinnerContainer.style.width = '256px';
    ...
    imgSpinner.style.animation = 'spin1 3s infinite linear';
    imgSpinner.style.webkitAnimation = 'spin1 3s infinite linear';
  ...
  // Resize
  private readonly _resizeLoadingUI = () => {
