  ...
  return (
    <>
      ...
      <div className={`container ${address ? '' : 'd-none'}`}>
        <div
          className="inventory-container d-flex opened"
          style={{ top: '30vh', height: '30vw', left: '32%' }}
        >
          <div className="inventory" style={{ height: '36%' }}>
            <div
              className="inventory-left-buttons d-flex flex-column"
              style={{ width: '150px', left: '-160px' }}
            >
              <div
                className="d-flex py-1 mt-5 mb-2 d-flex justify-content-center me-3"
                style={{
              ...
              >
                {selectedGems[0] != null ? (
                  ...
                  <div style={{ fontSize: '75px' }} className="text-white">
                    +
                  </div>
                )}
              </div>
              <div
                className="d-flex py-1 mt-2 mb-4 d-flex justify-content-center me-3"
                style={{
                  border: '1px solid #fff',
                  borderRadius: '12px',
                  minHeight: '135px',
              ...
              >
                {loader ? (
                  ...
                  <>
                    {userGems.map((gem) => (
                      <div
                        className={`col col-3 col-xl-2 border px-1 px-1 ${
                          selectedGems.includes(gem.id) && 'selected'
                        }`}
                        key={gem.id}
                      >
                        <div
        ...
        <div className="text-center position-relative" style={{ top: '66vh' }}>
          <button
            className="btn btn-secondary btn-lg px-3 pb-2 pt-2 me-3"
            style={{ fontSize: '19px', lineHeight: '36px', opacity: 0.9 }}
            onClick={handleMintGem}
          >
            Get Gems (Testnet)
          </button>
          <button
            className={`btn btn-lg px-5 pb-3 pt-3 ${
